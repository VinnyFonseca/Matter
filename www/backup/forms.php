...
<div class="main docs">
	...
	<div class="wrapper">
		...
		<form action="#" novalidate data-validation="true">
			...
			<label for="f23">File Upload</label>
			<input id="f23" type="file" data-validation="file" required>

			<label for="f23">Multiple File Uploads</label>
			<input type="file" data-multi="true" data-upload="5" required />
...
&lt;/fieldset&gt;
		...
		<p class="emphasis mobile-show">File uploads are not available on mobile devices.</p>
		...
		<input type="file" data-multi="true" />

<pre>
&lt;input type="file" <span class="emphasis">data-multi="true"</span> /&gt;
</pre>
